...
class Solver {
  ...
  late PreviewListener _listener;
...
class MasterSolver {
  late double firstTerm;
  late Operation firstOperation;
  late double secondTerm;
  late Operation secondOperation;
  bool needsSlave = false;
  late SlaveSolver slaveSolver;
  bool willRemoveSlave = false;
  late double tempPercentage;
  late double rate;
  ...
  void addOperation(Operation op) {
    ...
    if (resultRemembered) {
      ...
      var _secondTerm = null;
      secondTerm = _secondTerm;
      firstOperation = op;
      return;
    }
    if (firstTerm == null) {
